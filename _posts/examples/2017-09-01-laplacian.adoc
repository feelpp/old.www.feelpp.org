...
[stem]
++++
\left\{\begin{aligned}                                                                                                                                              -\Delta u &= f \text{ in } \Omega\\                                                                                                                           u &= g \text{ on } \partial \Omega_D\\
...
[source,cpp]
----
include::{source-uri}qs_laplacian.cpp[tag=mesh]
----
...
[source,cpp]
----
include::{source-uri}qs_laplacian.cpp[tag=discr]
----
...
[source,cpp]
----
include::{source-uri}qs_laplacian.cpp[tag=vf]
----
...
[source,cpp]
----
include::{source-uri}qs_laplacian.cpp[tag=ug]
----
